...
import gamemei.qiyun.com.gamemei.dao.ChannelDao;
...
public class ChannelManage {
    ...
    static {
        ...
        defaultUserChannels.add(new ChannelItem(7, "GameMei游戏引擎", 7, 1));
        //其他关注
        defaultOtherChannels = new ArrayList<ChannelItem>();
        defaultOtherChannels.add(new ChannelItem(8, "魔兽世界", 1, 0));
        defaultOtherChannels.add(new ChannelItem(9, "炉石传说英雄传", 2, 0));
        ...
        defaultOtherChannels.add(new ChannelItem(13, "刀塔传奇", 6, 0));
